...
export default function Contact({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:er.ranahimanshu@gmail.com?subject=${formData.subject}&body=${formData.message} - ${formData.name} - ${formData.email}`;
  };
    ...
    <div className="h-screen relative flex flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col mt-14">
        ...
        <div className="flex flex-wrap gap-6 justify-center font-outfit text-xl font-extralight text-gray-500 mt-14">
          ...
          <p className="hover:text-gray-300 duration-200">
            <a href="https://twitter.com/itshkrana">twitter</a>
            <span className="inline-flex">
              <svg
                className="with-icon_icon__MHUeb"
                data-testid="geist-icon"
          ...
          <p className="hover:text-gray-300 duration-200">
            <a href="https://www.linkedin.com/in/himanshu-kumar-rana/">
              linkedin
            </a>
            <span className="inline-flex">
              <svg
          ...
          <p className="hover:text-gray-300 duration-200">
            <a href="https://github.com/HimanshukrRana">github</a>
            <span className="inline-flex">
              <svg
                className="with-icon_icon__MHUeb"
                data-testid="geist-icon"
        ...
        <h5 className="mt-28">
          <p className="text-xl font-md font-outfit text-gray-200 md:ml-5">
            or drop a mail at{" "}
            <a
              href="mailto:er.ranahimanshu@gmail.com"
              className="cursor-pointer"
            >
              <span className="link link-underline link-underline-black">
                {" "}
                er.ranahimanshu@gmail.com
              </span>
            </a>
            <span className="inline-flex">
              <svg
      ...
      <div className="text-sm bottom-10 items-center justify-center absolute flex font-outfit text-gray-500">
        <p>
          ...
          <span className="underline decoration-blue-900">
            <a
              target={"_blank"}
              href="https://twitter.com/itshkrana"
              rel="noreferrer"
            >
              Himanshu
            </a>
